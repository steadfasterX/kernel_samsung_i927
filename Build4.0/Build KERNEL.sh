...
cp -a ./arch/arm/boot/zImage ./Build4.0

cp -a ./drivers/net/wireless/bcmdhd/dhd.ko ./Build4.0/ramdisk/lib/modules

cp -a ./drivers/scsi/scsi_wait_scan.ko ./Build4.0/ramdisk/lib/modules

cp -a ./drivers/misc/fm_si4709/Si4709_driver.ko ./Build4.0/ramdisk/lib/modules

cp -a ./drivers/nfc/pn544.ko ./Build4.0/ramdisk/lib/modules
...
cp -a ./boot.img /mnt/hgfs/LiteKernel--ICS-OUTPUT
...
cp -a ./$ZIP_NAME /mnt/hgfs/LiteKernel--ICS-OUTPUT
