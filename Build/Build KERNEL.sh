...
cp -a ./drivers/misc/fm_si4709/Si4709_driver.ko ./Build/ramdisk/lib/modules

cp -a ./drivers/nfc/pn544.ko ./Build/ramdisk/lib/modules
...
cp -a ./boot.img /mnt/hgfs/LiteKernel--4.1-OUTPUT
...
cp -a ./$ZIP_NAME /mnt/hgfs/LiteKernel--4.1-OUTPUT
